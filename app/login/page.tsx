...
export default function LoginPage() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "var(--font-sans, Inter, sans-serif)" }}>
      ...
      {/* ── Left panel — brand ───────────────────────────────── */}
      <div style={{
        width: "42%", flexShrink: 0, background: "#0A0B10",
        display: "flex", flexDirection: "column",
        position: "relative", overflow: "hidden",
      }}>
        {/* Lightning accent — echoes the parallelogram mark */}
        ...
        <div style={{ position: "absolute", left: -60, top: -60, width: 320, height: 320, opacity: 0.03, pointerEvents: "none" }}>
          <div style={{ width: "100%", height: "100%", background: "#0953FF", transform: "skewX(-30deg)", borderRadius: 40 }} />
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 52px", position: "relative" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 52 }}>
            <div style={{ width: 36, height: 36, borderRadius: 9, background: "#0953FF", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <svg width="20" height="20" viewBox="0 0 132 132" fill="none">
                <path d="M63.1304 111.913V68.8696H103.304L63.1304 111.913ZM63.1304 68.8696H22.9565L63.1304 22.9565H103.304L63.1304 68.8696Z" fill="white"/>
              </svg>
            </div>
            <svg height="18" viewBox="0 0 132 38" fill="none" style={{ display: "block" }}>
          ...
          <h1 style={{ fontFamily: "'Inter Tight', 'Inter', sans-serif", fontSize: 36, fontWeight: 600, color: "white", letterSpacing: "-0.025em", margin: "0 0 16px", lineHeight: 1.1 }}>
            Your crypto<br />outreach,<br />organized.
          </h1>
          <p style={{ fontSize: 14, color: "#6E7280", lineHeight: 1.6, margin: 0, maxWidth: 300 }}>
            Track contacts, manage your pipeline, and close deals — built for crypto-native teams.
          </p>

          {/* Feature list */}
          <div style={{ marginTop: 48, display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              "Telegram & Twitter outreach tracking",
              "Kanban pipeline with deal panels",
              "Tasks, notes & file attachments",
            ].map((f) => (
              <div key={f} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ width: 18, height: 18, borderRadius: 999, background: "rgba(9,83,255,0.25)", border: "1px solid rgba(9,83,255,0.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#4D86FF" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M4 12.5l5 5L20 6"/>
                  </svg>
                </div>
                <span style={{ fontSize: 13, color: "#A6AAB4", fontWeight: 500 }}>{f}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ width: "100%", maxWidth: 380 }}>
          ...
          <div style={{ background: "white", border: "1px solid #DCDFE5", borderRadius: 16, padding: "36px 32px", boxShadow: "0 4px 24px rgba(10,11,16,0.06)" }}>
            <div style={{ marginBottom: 28 }}>
              ...
              <p style={{ fontSize: 13, color: "#6E7280", margin: 0 }}>Sign in to your workspace</p>
            </div>

            <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div>
                <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#4A4E5A", marginBottom: 6, letterSpacing: "0.01em" }}>
                  Email
                </label>
                <input
                  ref={emailRef}
              ...
              <button
                ...
                style={{
                  marginTop: 4,
                  height: 42, width: "100%",
                  background: loading ? "#4A4E5A" : "#0A0B10",
